    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                // Call GetCard method to get the appropriate number of cards
                ...
                //int clubCount = hand.Count(card => card.Suit == Suit.Clubs);
                //int diamondCount = hand.Count(card => card.Suit == Suit.Diamonds);
                //int heartCount = hand.Count(card => card.Suit == Suit.Hearts);
                //int spadeCount = hand.Count(card => card.Suit == Suit.Spades);
                ...
                // Print the counts of each suit
                Console.WriteLine($"{clubCount} {diamondCount} {heartCount} {spadeCount}");
