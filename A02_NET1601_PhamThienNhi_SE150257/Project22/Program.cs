    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                int sum = 0;
                int value;
                // Read values and process them until -1 is encountered
                ...
                if (count > 0)
                {
                    ...
                    // Format the mean to have one decimal place
                    Console.WriteLine($"{count} {mean:F1}");
                }
                else
                {
                    // Handle the case where no values were processed
